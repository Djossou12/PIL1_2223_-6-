...
urlpatterns = [
    ...
    path('IA1',views.IA1, name='IA_1'),

    path('IA2',views.IA2, name='IA_2'),

    path('IA3',views.IA3, name='IA_3'),

    path('IM1',views.IM1, name='IM_1'),

    path('IM2',views.IM2, name='IM_2'),

    path('IM3',views.IM3, name='IM_3'),

    path('GL1',views.GL1, name='GL_1'),

    path('GL2',views.GL2, name='GL_2'),

    path('GL3',views.GL3, name='GL_3'),
    ...
    path('SI1',views.SI1, name='SI_1'),

    path('SI2',views.SI2, name='SI_2'),

    path('SI3',views.SI3, name='SI_3'),
